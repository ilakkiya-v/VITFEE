        ...
        <form class="form-default" action = " "  method="POST">
            ...
            <div class="login-form">
                ...
                <div class="form-input">
                    <label for="regno">Email ID</label>
                    <input  type="text" name="email" placeholder="email">
                </div>
                <div class="form-input pt-30">
                    <input type="submit" name="submit" value="submit">
                </div>
				 <a href="index.php" class="forget">Go to Login Page</a> 
...
$con = new mysqli("localhost", "root", "harstin1994", "vitfeepayment");
 ...
 $sql = "SELECT * FROM stud_prof where email = '$email'";
    ...
    while ($row_data = mysqli_fetch_array($result)) {
	   ...
	   $pwd = $row_data['password'];
        ...
        $msg = " Hi! $name here is your password: $pwd";
